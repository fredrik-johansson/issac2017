...
$\mathbb{Z}$, since the null ideal of a matrix $M$ over
...
Singular \cite{singular} is a C/C++ package for commutative algebra, polynomial systems and algebraic
geometry. Recently, we have helped prepare a Julia package called Singular.jl, which is compatible with
