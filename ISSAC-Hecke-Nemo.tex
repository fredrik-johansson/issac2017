...
\bibitem{gmp}
T. Granlund and the GMP development team \emph{The GNU Multi Precision Arithmetic 
Library} \url{http://gmplib.org/}

\bibitem{flint}
W. Hart, F. Johansson and S. Pancratz. {\em FLINT: Fast Library for Number Theory}. \url{http://www.flintlib.org}
...
\bibitem{pari}
The PARI~Group, {\em PARI/GP version 2.9.0}, Univ. Bordeaux, 2016, \url{http://pari.math.u-bordeaux.fr/}.

\bibitem{sage}
The Sage Developers, {\em SageMath, the Sage Mathematics Software System (Version 7.4)}, 2016.  \url{http://www.sagemath.org}
