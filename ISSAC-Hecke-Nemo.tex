...
Basic use of Nemo is demonstrated with a few benchmark examples.
...
\subsection{Generic and specialised types}
...
\begin{table}
\center
\caption{Time on the Fateman benchmark.}
\begin{small}
...
\begin{table}
\center
\caption{Time on the Pearce benchmark.}
\begin{small}
\setlength{\tabcolsep}{2.5pt}
\renewcommand{\arraystretch}{1.2}
...
\subsubsection{Generic resultant}
...
\subsubsection{Generic linear algebra}
...
In this section, we discuss some of the algorithms
implemented in Nemo for generic polynomials and matrices.
