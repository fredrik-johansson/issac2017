...
implementation.
For specialised algorithms, we exploit Julia's efficient
...
Julia uses a familiar imperative syntax similar to Python or Matlab,
with support for operator overloading.
It provides high performance builtin collection types (dictionaries, iterators, arrays, etc.)
and comes with a powerful standard library.
Julia also provides an interactive console and can be used with Jupyter notebooks.
