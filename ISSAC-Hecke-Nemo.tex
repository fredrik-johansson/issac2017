...
acceptable at the point where an object is being created.
...
In Julia, in-place operators save not only memory allocation overheads, but also
...
Nemo implements both relative and absolute power series. 

Nemo also provides a module for generic multivariate polynomials in sparse distributed
format. We make use of variants of the sparse algorithms described by Monagan and
...
sufficient space to store a full polynomial product, rather the reduction of such a product.
