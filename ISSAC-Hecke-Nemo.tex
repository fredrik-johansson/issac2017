...
Low-level C libraries such as GMP/MPIR and Flint allow mutating
objects in-place. This makes a big difference for performance,
...
recursively down to the ground level C objects.
